...
function showProductDetail() {
    ...
    // Lấy ra chuỗi string của url hiện tại từ dấu ? đến cuối
    const queryString = window.location.search;
     // Tách ra mảng 2 phần tử bởi dấu =
    const arrParam = queryString.split('=');
    // Lấy ra id chính là phần tử cuối của mảng
    ...
    // document.querySelector('.pr_desc p').innerText = product.description;
